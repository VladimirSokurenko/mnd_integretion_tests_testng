...
public class PortfolioPage {
    ...
    WebElement portfolio_item_cover_image;
      ...
      public void verify_main_heading_present(){
          if(portfolio_main_heading.isDisplayed()){
              System.out.println("Profile main heading is present");
          } else {
              System.out.println("Profile main heading is NOT present");
          }
      }
      ...
      public void verify_avatar_is_displayed(){
         if(portfolio_avatar_placeholder.isDisplayed()){
             System.out.println("Profile avatar is displayed");
         } else {
             System.out.println("Profile avatar is NOT displayed");
         }
      }

      public void verify_cover_image_is_displayed(){
          if (portfolio_cover_iamge.isDisplayed()){
              System.out.println("Profile cover image is displayed");
        }else {
              System.out.println("Profile cover image is NOT displayed");
          }
      }
      ...
      public void verify_portfolio_item_cover_image(){
          if(portfolio_item_cover_image.isDisplayed()){
              System.out.println("portfolio item cover image is displayed");
          } else {
              System.out.println("portfolio item cover image is NOT displayed");
          }
      }

      public void click_edit_portfolio_item_btn(){
          btn_edit_portfolio_item.click();
      }

      public void click_portfolio_item_card(){ portfolio_item_card.click(); }

      public void verify_portfolio_item_deleted(String title_text){
          Assert.assertNotEquals(portfolio_item_title.getText(), title_text);
      }
